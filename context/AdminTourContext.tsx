...
export const adminTourSteps = [
  ...
  { id: 5, screen: '/admin/settings', title: 'Security & PIN Management', description: 'Set up your Login PIN for authentication and Security PIN for sensitive operations. Enable auto-logout for extra security.', highlight: { x: 20, y: 200, width: 390, height: 300 } },
