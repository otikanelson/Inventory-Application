...
export const AdminTourOverlay: React.FC = () => {
  const { theme } = useTheme();
  const { isTourActive, currentStep, nextStep, previousStep, skipTour } = useAdminTour();
  ...
  if (!isTourActive || currentStep >= adminTourSteps.length) return null;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Ionicons name="shield-checkmark" size={16} color="#4C6FFF" />
        </Animated.View>
